...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 28, 2020 at 12:36 AM
...
CREATE TABLE IF NOT EXISTS `employees` (
  ...
  `phone__number` varchar(20) DEFAULT NULL,
...
INSERT INTO `employees` (`employee_id`, `first_name`, `last_name`, `email`, `phone__number`, `hire_date`, `job_id`, `salary`, `commission_pct`, `manager_id`, `department_id`) VALUES
...
(108, 'Nancy', 'Greenberg', 'NGREENBE', '515.999.4569', '1987-06-25', 'FI_MGR', 12000, 0, 101, 100),
(109, 'Daniel', 'Faviet', 'DFAVIET', '515.999.4169', '1987-06-26', 'FI_ACCOUNT', 9000, 0, 108, 100),
(110, 'John', 'Chen', 'JCHEN', '515.999.4269', '1987-06-27', 'FI_ACCOUNT', 8200, 0, 108, 100),
(111, 'Ismael', 'Sciarra', 'ISCIARRA', '515.999.4369', '1987-06-28', 'FI_ACCOUNT', 7700, 0, 108, 100),
(112, 'Jose Manuel', 'Urman', 'JMURMAN', '515.999.4469', '1987-06-29', 'FI_ACCOUNT', 7800, 0, 108, 100),
(113, 'Luis', 'Popp', 'LPOPP', '515.999.4567', '1987-06-30', 'FI_ACCOUNT', 6900, 0, 108, 100),
...
(125, 'Julia', 'Nayer', 'JNAYER', '650.999.1214', '1987-07-12', 'ST_CLERK', 3200, 0, 120, 50),
(126, 'Irene', 'Mikkilineni', 'IMIKKILI', '650.999.1224', '1987-07-13', 'ST_CLERK', 2700, 0, 120, 50),
(127, 'James', 'Landry', 'JLANDRY', '650.999.1334', '1987-07-14', 'ST_CLERK', 2400, 0, 120, 50),
(128, 'Steven', 'Markle', 'SMARKLE', '650.999.1434', '1987-07-15', 'ST_CLERK', 2200, 0, 120, 50),
(129, 'Laura', 'Bissot', 'LBISSOT', '650.999.5234', '1987-07-16', 'ST_CLERK', 3300, 0, 121, 50),
(130, 'Mozhe', 'Atkinson', 'MATKINSO', '650.999.6234', '1987-07-17', 'ST_CLERK', 2800, 0, 121, 50),
(131, 'James', 'Marlow', 'JAMRLOW', '650.999.7234', '1987-07-18', 'ST_CLERK', 2500, 0, 121, 50),
(132, 'TJ', 'Olson', 'TJOLSON', '650.999.8234', '1987-07-19', 'ST_CLERK', 2100, 0, 121, 50),
...
(145, 'John', 'Russell', 'JRUSSEL', '011.44.1344.429268', '1987-08-01', 'SA_MAN', 14000, 0, 100, 80),
(146, 'Karen', 'Partners', 'KPARTNER', '011.44.1344.467268', '1987-08-02', 'SA_MAN', 13500, 0, 100, 80),
(147, 'Alberto', 'Errazuriz', 'AERRAZUR', '011.44.1344.429278', '1987-08-03', 'SA_MAN', 12000, 0, 100, 80),
(148, 'Gerald', 'Cambrault', 'GCAMBRAU', '011.44.1344.619268', '1987-08-04', 'SA_MAN', 11000, 0, 100, 80),
(149, 'Eleni', 'Zlotkey', 'EZLOTKEY', '011.44.1344.429018', '1987-08-05', 'SA_MAN', 10500, 0, 100, 80),
(150, 'Peter', 'Tucker', 'PTUCKER', '011.44.1344.129268', '1987-08-06', 'SA_REP', 10000, 0, 145, 80),
(151, 'David', 'Bernstein', 'DBERNSTE', '011.44.1344.345268', '1987-08-07', 'SA_REP', 9500, 0, 145, 80),
(152, 'Peter', 'Hall', 'PHALL', '011.44.1344.478968', '1987-08-08', 'SA_REP', 9000, 0, 145, 80),
(153, 'Christopher', 'Olsen', 'COLSEN', '011.44.1344.498718', '1987-08-09', 'SA_REP', 8000, 0, 145, 80),
(154, 'Nanette', 'Cambrault', 'NCAMBRAU', '011.44.1344.987668', '1987-08-10', 'SA_REP', 7500, 0, 145, 80),
(155, 'Oliver', 'Tuvault', 'OTUVAULT', '011.44.1344.486508', '1987-08-11', 'SA_REP', 7000, 0, 145, 80),
(156, 'Janette', 'King', 'JKING', '011.44.1345.429268', '1987-08-12', 'SA_REP', 10000, 0, 146, 80),
(157, 'Patrick', 'Sully', 'PSULLY', '011.44.1345.929268', '1987-08-13', 'SA_REP', 9500, 0, 146, 80),
(158, 'Allan', 'McEwen', 'AMCEWEN', '011.44.1345.829268', '1987-08-14', 'SA_REP', 9000, 0, 146, 80),
(159, 'Lindsey', 'Smith', 'LSMITH', '011.44.1345.729268', '1987-08-15', 'SA_REP', 8000, 0, 146, 80),
(160, 'Louise', 'Doran', 'LDORAN', '011.44.1345.629268', '1987-08-16', 'SA_REP', 7500, 0, 146, 80),
(161, 'Sarath', 'Sewall', 'SSEWALL', '011.44.1345.529268', '1987-08-17', 'SA_REP', 7000, 0, 146, 80),
(162, 'Clara', 'Vishney', 'CVISHNEY', '011.44.1346.129268', '1987-08-18', 'SA_REP', 10500, 0, 147, 80),
(163, 'Danielle', 'Greene', 'DGREENE', '011.44.1346.229268', '1987-08-19', 'SA_REP', 9500, 0, 147, 80),
(164, 'Mattea', 'Marvins', 'MMARVINS', '011.44.1346.329268', '1987-08-20', 'SA_REP', 7200, 0, 147, 80),
(165, 'David', 'Lee', 'DLEE', '011.44.1346.529268', '1987-08-21', 'SA_REP', 6800, 0, 147, 80),
(166, 'Sundar', 'Ande', 'SANDE', '011.44.1346.629268', '1987-08-22', 'SA_REP', 6400, 0, 147, 80),
(167, 'Amit', 'Banda', 'ABANDA', '011.44.1346.729268', '1987-08-23', 'SA_REP', 6200, 0, 147, 80),
(168, 'Lisa', 'Ozer', 'LOZER', '011.44.1343.929268', '1987-08-24', 'SA_REP', 11500, 0, 148, 80),
(169, 'Harrison', 'Bloom', 'HBLOOM', '011.44.1343.829268', '1987-08-25', 'SA_REP', 10000, 0, 148, 80),
(170, 'Tayler', 'Fox', 'TFOX', '011.44.1343.729268', '1987-08-26', 'SA_REP', 9600, 0, 148, 80),
(171, 'William', 'Smith', 'WSMITH', '011.44.1343.629268', '1987-08-27', 'SA_REP', 7400, 0, 148, 80),
(172, 'Elizabeth', 'Bates', 'EBATES', '011.44.1343.529268', '1987-08-28', 'SA_REP', 7300, 0, 148, 80),
(173, 'Sundita', 'Kumar', 'SKUMAR', '011.44.1343.329268', '1987-08-29', 'SA_REP', 6100, 0, 148, 80),
(174, 'Ellen', 'Abel', 'EABEL', '011.44.1644.429267', '1987-08-30', 'SA_REP', 11000, 0, 149, 80),
(175, 'Alyssa', 'Hutton', 'AHUTTON', '011.44.1644.429266', '1987-08-31', 'SA_REP', 8800, 0, 149, 80),
(176, 'Jonathon', 'Taylor', 'JTAYLOR', '011.44.1644.429265', '1987-09-01', 'SA_REP', 8600, 0, 149, 80),
(177, 'Jack', 'Livingston', 'JLIVINGS', '011.44.1644.429264', '1987-09-02', 'SA_REP', 8400, 0, 149, 80),
(178, 'Kimberely', 'Grant', 'KGRANT', '011.44.1644.429263', '1987-09-03', 'SA_REP', 7000, 0, 149, 0),
(179, 'Charles', 'Johnson', 'CJOHNSON', '011.44.1644.429262', '1987-09-04', 'SA_REP', 6200, 0, 149, 80),
